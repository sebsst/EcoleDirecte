...
$plugin = plugin::byId('ecoleDirecte');
...
<div class="row row-overflow">
	<div class="col-lg-2 col-sm-9 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un ecoleDirecte}}</a>
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		...
		<legend><i class="fa fa-table"></i> {{Mes comptes}}</legend>
		<div class="eqLogicThumbnailContainer">
...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
	...
	<a class="btn btn-default pull-right" id="bt_wl_modal"><i class="fa fa-cogs"></i> {{accès école directe}}</a>
			...
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
						<label class="col-sm-3 control-label">{{Compte école directe}}</label>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="identifiant" type="text" placeholder="{{Identifiant}}">
						</div>
					</div>
						...
						<div class="col-sm-3">
							<input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="motdepasse" type="password" placeholder="{{saisir le mot de passe}}">
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">{{Prénom enfant}}</label>
							<div class="col-sm-3">
								<input class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="prenom" type="text" placeholder="{{Prénom}}">
							</div>
						</div>
...
<?php include_file('desktop', 'ecoleDirecte', 'js', 'ecoleDirecte');?>
